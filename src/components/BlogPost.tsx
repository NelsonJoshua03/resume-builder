...
const BlogPost: React.FC = () => {
  ...
  const { trackBlogPostReadEnhanced, trackDailyPageView } = useEnhancedAnalytics();
  ...
  const handleInternalLinkClick = (linkText: string) => {
    trackButtonClick(`blog_link_${linkText}`, 'blog_content', 'blog');
    trackBlogPostEngagement(post?.slug || '', post?.title || '', 'internal_link_click');
  };
                    ...
                    a: ({node, children, ...props}) => {
                      ...
                      return (
                        <a 
                          ...
                          onClick={(e) => {
                            if (isInternalLink) {
                              handleInternalLinkClick(children?.toString() || 'unknown');
                            }
                          }}
                          {...props}
                        >
                          ...
                          <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-5 py-3 flex justify-between items-center">
                            ...
                            <button 
                              onClick={() => {
                                ...
                                trackButtonClick('copy_code_block', 'blog_content', 'blog');
                              }}
