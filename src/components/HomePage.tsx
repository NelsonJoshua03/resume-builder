...
const HomePage = () => {
  return (
    <>
      <SEO
        title="Free ATS-Friendly Resume Builder - Professional CV Templates 2024"
        description="Create professional, ATS-optimized resumes in minutes. Free templates for engineers, developers, and IT professionals. Download as PDF instantly - no sign up required."
        keywords="free resume builder, ATS resume template, professional CV maker, engineering resume, software developer CV, instant download, ATS-friendly resume"
        canonicalUrl="https://resumecvforge.netlify.app/"
      />
